...
Source0  : https://cran.r-project.org/src/contrib/utf8_1.1.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521230140
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library utf8|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
